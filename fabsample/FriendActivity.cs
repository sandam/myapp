...
using FabSample.Adapters;
using FabSample.Models;

using com.refractored.monodroidtoolkit.imageloader;

namespace FabSample.Activities
{
	[Activity(Label = "Friend",ParentActivity = typeof(HomeActivity))]
	[MetaData("android.support.PARENT_ACTIVITY", Value = "fabsample.activities.HomeActivity")]
